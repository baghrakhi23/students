        ...
        <div class="login-bg-color bg-black-300">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                        ...
                        <div class="panel-body p-20">
                            ...
                            <form action="result.php" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="rollid" placeholder="Enter Your Roll Id" name="rollid">
                                </div>
                                <div class="form-group">
                    ...
                    <!-- /.panel -->
                    <p class="text-muted text-center"><small>Copyright © <a href="https://www.asdacademy.in/">ASDAcademy</a> </small></p>
                    </div>
