                                                            ...
                                                            foreach ($results as $result) {   ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a href="manage-classes.php?del=<?php echo htmlentities($result->id); ?>" onclick="return confirm('Are you sure you want to delete this courses?');"><i class="fa fa-trash" title="Delete Record"></i></a>
                                                                    </td>
                                                                </tr>
                                                        <?php $cnt = $cnt + 1;
                                                            }
